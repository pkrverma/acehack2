        ...
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row w-[70%] flex-wrap justify-evenly text-sky-100/90">
                <div className="text-center w-80 flex flex-col items-center">
                    ...
                    <h1 className="text-xl font-semibold">Meet India’s biggest Tech Giants</h1>
                </div>
                <div className="text-center w-80 flex flex-col items-center">
                    <img src={people} alt="meeting" className="h-48 mt-10 mb-3"/>
                    <h1 className="text-xl font-semibold">Connect with like-minded people</h1>
                </div>
                <div className="text-center w-80 flex flex-col items-center">
                    <img src={project} alt="meeting" className="h-48 mt-10 mb-3"/>
                    <h1 className="text-xl font-semibold">Opportunities to work on a real life problem statement</h1>
                </div>
                <div className="text-center w-80 flex flex-col items-center">
                ...
                <div className="text-center w-80 flex flex-col items-center">
                    ...
                    <h1 className="text-xl font-semibold">Get free food & fun environment</h1>
                </div>
            </div>
        </div>
        </div>
