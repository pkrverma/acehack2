        ...
        <div className="flex flex-col w-full items-center">
          ...
          <div className="flex flex-row flex-wrap mx-4 md:mx-10 gap-4 justify-center">
            ...
            <PrizeItem
              ...
              prize="$ 50"
            />
            <PrizeItem color="text-cyan-300" title="Young Gun:" prize="$ 100" />
            <PrizeItem
              color="text-cyan-300"
        ...
        <div className="w-4/5 flex flex-col items-end">
          ...
          <Collapsible label="Wolfram Instructions +" style="pl-6 text-right">
            ...
            <p>
              ...
              days. Access to Wolfram|One for all your participants for thirty
              days. Wolfram|One includes both Desktop and Cloud access, full
              access to the Wolfram Language and Knowledgebase, FreeCDF
            ...
            <p>
              -{">"} The Wolfram Award for everyone on your top seven teams via
              award letter with a maximum of five individuals per team, or up to
              35 individual participants. We would like for your organizing team
              to choose the winning students. Wolfram tech is not required to be
              used in projects for our award eligibility. I would send you the
              award letter as a .pdf attachment and you would need to email it
              to the winners.
            </p>
            </div>
          </Collapsible>
